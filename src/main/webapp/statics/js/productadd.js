...
$(function(){
	...
	$.ajax({
		type:"GET",//请求类型
		url:path+"/product/pcList.json",//请求的url
		...
		error:function(data){//当访问时候，404，500 等非200的错误状态码
			validateTip(cl1.next(),{"color":"red"},imgNo+" 获取商品类别列表error",false);
		}
	});
	...
	cl1.change(function(){
		$.ajax({
			...
			error:function(data){//当访问时候，404，500 等非200的错误状态码
				validateTip(cl2.next(),{"color":"red"},imgNo+" 获取商品类别列表error",false);
			}
		});
	});
	...
	cl2.change(function(){
		$.ajax({
			...
			error:function(data){//当访问时候，404，500 等非200的错误状态码
				validateTip(cl3.next(),{"color":"red"},imgNo+" 获取商品类别列表error",false);
			}
		});
	});
	/*
